...
int main()
{
    ...
    int recv_info_len=recvfrom(client_sock,exist_info,MAXLEN,0, (SOCKADDR *)&server_addr, &socket_len);
    if(exist_info[0]=='F')
    {
	...
	while (1)
    {
        ...
        file_content_len = recvfrom(client_sock,file_download_buffer,MAXLEN,0, (SOCKADDR *)&server_addr, &socket_len);
